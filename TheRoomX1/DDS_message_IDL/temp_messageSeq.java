...
/**
* A sequence of temp_message instances.
*/
public final class temp_messageSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public temp_messageSeq() {
        super(temp_message.class);
    }

    public temp_messageSeq (int initialMaximum) {
        super(temp_message.class, initialMaximum);
    }

    public temp_messageSeq (Collection elements) {
        super(temp_message.class, elements);
    }

    public  temp_message get(int index) { 
        return (temp_message) super.get(index); 
    }
