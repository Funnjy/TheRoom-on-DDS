...
public class temp_messageTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "temp_message";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final temp_messageTypeSupport _singleton
    = new temp_messageTypeSupport();
    ...
    */
    public static temp_messageTypeSupport get_instance() {
        return _singleton;
    }

    public static temp_messageTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return temp_messageTypeCode.VALUE;
    }

    public Object create_data() {
        return temp_message.create();
    }
    ...
    * <code>this</code> is not a <code>temp_message</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        temp_message typedDst = (temp_message) destination;
        temp_message typedSrc = (temp_message) source;
        ...
        Object sample) 
    {
        ...
        temp_message typedSrc = (temp_message) sample;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.txt );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.txt,128);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            temp_message typedDst = (temp_message) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.txt = src.readString(128);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            temp_message typedDst = (temp_message) sample;
    ...
    int mask) {
        return new temp_messageDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new temp_messageDataReader(native_reader, listener, mask, this);   
    ...
    protected temp_messageTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,temp_messageTypeCode.VALUE,temp_message.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected temp_messageTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,temp_messageTypeCode.VALUE,temp_message.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
