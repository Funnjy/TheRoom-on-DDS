...
TellstickManager_tlstick = (TellstickManager) new TellstickManager("tlstick (TellstickManager)", (String)null, (short)0, (String)null, (String)null, (short)0, (short)0, (short)0, (float)0.0f, (int)0, (int)0, (String)null, (String)null, (int)0, (String)null, (int)0).buildBehavior(null, null);
...
PIM_pim = (PIM) new PIM("pim (PIM)", pim_thermometers_array, pim_thermotext_array, pim_thermoval_array, (short) (0), (int)0, (float)0.0f, (boolean)false, (short)0).buildBehavior(null, null);
...
ThermometerSet_T1 = (ThermometerSet) new ThermometerSet("T1 (ThermometerSet)", (String)null, T1_thermometers_array, T1_thermotext_array, T1_thermoval_array, (short) (0), (short)0, (short) (10000), (int)0, (short)0, (float)0.0f, (boolean)false, (short)0).buildBehavior(null, null);
