...
public class TellstickManager extends Component {
	...
	private Collection<ITellstickManager_to_T1Client> to_T1_clients = Collections
			.synchronizedCollection(new LinkedList<ITellstickManager_to_T1Client>());
	...
	private Collection<ITellstickManager_to_onoff1Client> to_onoff1_clients = Collections
			.synchronizedCollection(new LinkedList<ITellstickManager_to_onoff1Client>());
	...
	private Collection<ITellstickManager_to_gdgClient> to_gdg_clients = Collections
			.synchronizedCollection(new LinkedList<ITellstickManager_to_gdgClient>());
	...
	private void sendSensorinfo_via_to_gdg(String GeneralMsg_sensorinfo_model_var,
			String GeneralMsg_sensorinfo_proto_var, short GeneralMsg_sensorinfo_sid_var,
			short GeneralMsg_sensorinfo_dataTypes_var, float GeneralMsg_sensorinfo_temperature_var,
			int GeneralMsg_sensorinfo_humidity_var, int GeneralMsg_sensorinfo_timeStamp_var) {
		// ThingML send
		to_gdg_port.send(sensorinfoType.instantiate(GeneralMsg_sensorinfo_model_var, GeneralMsg_sensorinfo_proto_var,
				GeneralMsg_sensorinfo_sid_var, GeneralMsg_sensorinfo_dataTypes_var,
				GeneralMsg_sensorinfo_temperature_var, GeneralMsg_sensorinfo_humidity_var,
				GeneralMsg_sensorinfo_timeStamp_var));
		// send to other clients
		for (ITellstickManager_to_gdgClient client : to_gdg_clients) {
			client.sensorinfo_from_to_gdg(GeneralMsg_sensorinfo_model_var, GeneralMsg_sensorinfo_proto_var,
					GeneralMsg_sensorinfo_sid_var, GeneralMsg_sensorinfo_dataTypes_var,
					GeneralMsg_sensorinfo_temperature_var, GeneralMsg_sensorinfo_humidity_var,
					GeneralMsg_sensorinfo_timeStamp_var);
		}
	...
	private void sendDeviceinfo_via_to_gdg(short GeneralMsg_deviceinfo_did_var, String GeneralMsg_deviceinfo_name_var,
			String GeneralMsg_deviceinfo_model_var, String GeneralMsg_deviceinfo_proto_var,
			String GeneralMsg_deviceinfo_ttype_var, short GeneralMsg_deviceinfo_meth_var,
			String GeneralMsg_deviceinfo_lastCmd_var, int GeneralMsg_deviceinfo_lastValue_var) {
		// ThingML send
		to_gdg_port.send(deviceinfoType.instantiate(GeneralMsg_deviceinfo_did_var, GeneralMsg_deviceinfo_name_var,
				GeneralMsg_deviceinfo_model_var, GeneralMsg_deviceinfo_proto_var, GeneralMsg_deviceinfo_ttype_var,
				GeneralMsg_deviceinfo_meth_var, GeneralMsg_deviceinfo_lastCmd_var,
				GeneralMsg_deviceinfo_lastValue_var));
		// send to other clients
		for (ITellstickManager_to_gdgClient client : to_gdg_clients) {
			client.deviceinfo_from_to_gdg(GeneralMsg_deviceinfo_did_var, GeneralMsg_deviceinfo_name_var,
					GeneralMsg_deviceinfo_model_var, GeneralMsg_deviceinfo_proto_var, GeneralMsg_deviceinfo_ttype_var,
					GeneralMsg_deviceinfo_meth_var, GeneralMsg_deviceinfo_lastCmd_var,
					GeneralMsg_deviceinfo_lastValue_var);
		}
	...
	public TellstickManager(String name, final String TellstickManager_ts_var, final short TellstickManager_i_var,
			final String TellstickManager_model_var, final String TellstickManager_proto_var,
			final short TellstickManager_sid_var, final short TellstickManager_did_var,
			final short TellstickManager_dataTypes_var, final float TellstickManager_temperature_var,
			final int TellstickManager_humidity_var, final int TellstickManager_timeStamp_var,
			final String TellstickManager_name_var, final String TellstickManager_devicetype_var,
			final int TellstickManager_devicemethods_var, final String TellstickManager_devicelastcmd_var,
			final int TellstickManager_devicelastval_var) {
		super(name);
	...
	private CompositeState buildTellstickManager_TellstickBehavior() {
		...
		final CompositeState state_TellstickManager_TellstickBehavior = new CompositeState("TellstickBehavior",
				states_TellstickManager_TellstickBehavior, state_TellstickManager_TellstickBehavior_Init,
				transitions_TellstickManager_TellstickBehavior, regions_TellstickManager_TellstickBehavior, false);
	...
	private void observe_sensors() {
		...
		sendSensorinfo_via_to_gdg((String) (getTellstickManager_model_var()),
				(String) (getTellstickManager_proto_var()), (short) (getTellstickManager_sid_var()),
				(short) (getTellstickManager_dataTypes_var()), (float) (getTellstickManager_temperature_var()),
				(int) (getTellstickManager_humidity_var()), (int) (getTellstickManager_timeStamp_var()));
	}
	...
	private void observe_devices() {
		...
		sendDeviceinfo_via_to_gdg((short) (getTellstickManager_did_var()), (String) (getTellstickManager_name_var()),
				(String) (getTellstickManager_model_var()), (String) (getTellstickManager_proto_var()),
				(String) (getTellstickManager_devicetype_var()), (short) (getTellstickManager_devicemethods_var()),
