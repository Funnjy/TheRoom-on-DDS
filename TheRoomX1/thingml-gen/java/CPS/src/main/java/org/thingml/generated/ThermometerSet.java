...
public ThermometerSet(String name, final String ThermometerSet_ts_var, final short[] ThermometerSet_thermometers_var, final String[] ThermometerSet_thermotext_var, final float[] ThermometerSet_thermoval_var, final short ThermometerSet_last_thermo_var, final short ThermometerSet_i_var, final short ThermometerSet_poll_intrvl_var, final int ThermometerSet_id_s_var, final short ThermometerSet_sensortype_var, final float ThermometerSet_temp_s_var, final boolean ThermometerSet_found_var, final short PSMSensorSet_sensors_var) {
super(name);
...
transitions_ThermometerSet_behaviorThermometerSet.add(new Transition("2033690126",initializeType, initial_port, state_ThermometerSet_behaviorThermometerSet_Init, state_ThermometerSet_behaviorThermometerSet_Idle){
@Override
...
transitions_ThermometerSet_behaviorThermometerSet.add(new Transition("815179920",timer_timeoutType, timer_port, state_ThermometerSet_behaviorThermometerSet_Idle, state_ThermometerSet_behaviorThermometerSet_Idle){
@Override
public void doExecute(final Event e) {
...
transitions_ThermometerSet_behaviorThermometerSet.add(new Transition("927805736",add_thermometerType, require_val_port, state_ThermometerSet_behaviorThermometerSet_Idle, state_ThermometerSet_behaviorThermometerSet_Idle){
@Override
public void doExecute(final Event e) {
...
transitions_ThermometerSet_behaviorThermometerSet.add(new Transition("726083556",temperatureType, get_values_port, state_ThermometerSet_behaviorThermometerSet_Idle, state_ThermometerSet_behaviorThermometerSet_Idle){
@Override
public void doExecute(final Event e) {
