 ...
 **/
public class ThermometerSet extends Component implements IThermometerSet_require_val, IThermometerSet_initial,
		IThermometerSet_get_values, IThermometerSet_timer {
	...
	private Collection<IThermometerSet_provide_valClient> provide_val_clients = Collections
			.synchronizedCollection(new LinkedList<IThermometerSet_provide_valClient>());
	...
	private Collection<IThermometerSet_show_valuesClient> show_values_clients = Collections
			.synchronizedCollection(new LinkedList<IThermometerSet_show_valuesClient>());
	...
	private Collection<IThermometerSet_timerClient> timer_clients = Collections
			.synchronizedCollection(new LinkedList<IThermometerSet_timerClient>());
	...
	@Override
	public synchronized void add_thermometer_via_require_val(short TemperatureMsg_add_thermometer_id_var,
			String TemperatureMsg_add_thermometer_txt_var) {
		receive(add_thermometerType.instantiate(TemperatureMsg_add_thermometer_id_var,
				TemperatureMsg_add_thermometer_txt_var), require_val_port);
	}
	...
	@Override
	public synchronized void temperature_via_get_values(short TemperatureMsg_temperature_id_var,
			String TemperatureMsg_temperature_txt_var, float TemperatureMsg_temperature_t_var) {
		receive(temperatureType.instantiate(TemperatureMsg_temperature_id_var, TemperatureMsg_temperature_txt_var,
				TemperatureMsg_temperature_t_var), get_values_port);
	}
	...
	private void sendTemperature_via_provide_val(short TemperatureMsg_temperature_id_var,
			String TemperatureMsg_temperature_txt_var, float TemperatureMsg_temperature_t_var) {
		// ThingML send
		provide_val_port.send(temperatureType.instantiate(TemperatureMsg_temperature_id_var,
				TemperatureMsg_temperature_txt_var, TemperatureMsg_temperature_t_var));
		// send to other clients
		for (IThermometerSet_provide_valClient client : provide_val_clients) {
			client.temperature_from_provide_val(TemperatureMsg_temperature_id_var, TemperatureMsg_temperature_txt_var,
					TemperatureMsg_temperature_t_var);
		}
	}

	private void sendTemperature_via_show_values(short TemperatureMsg_temperature_id_var,
			String TemperatureMsg_temperature_txt_var, float TemperatureMsg_temperature_t_var) {
		// ThingML send
		show_values_port.send(temperatureType.instantiate(TemperatureMsg_temperature_id_var,
				TemperatureMsg_temperature_txt_var, TemperatureMsg_temperature_t_var));
		// send to other clients
		for (IThermometerSet_show_valuesClient client : show_values_clients) {
			client.temperature_from_show_values(TemperatureMsg_temperature_id_var, TemperatureMsg_temperature_txt_var,
					TemperatureMsg_temperature_t_var);
		}
	}
	...
	public ThermometerSet(String name, final String ThermometerSet_ts_var,
			final short[] ThermometerSet_thermometers_var, final String[] ThermometerSet_thermotext_var,
			final float[] ThermometerSet_thermoval_var, final short ThermometerSet_last_thermo_var,
			final short ThermometerSet_i_var, final short ThermometerSet_poll_intrvl_var,
			final int ThermometerSet_id_s_var, final short ThermometerSet_sensortype_var,
			final float ThermometerSet_temp_s_var, final boolean ThermometerSet_found_var,
			final short PSMSensorSet_sensors_var) {
		super(name);
	...
	private CompositeState buildThermometerSet_behaviorThermometerSet() {
		...
		transitions_ThermometerSet_behaviorThermometerSet.add(new Transition("2033690126", initializeType, initial_port,
				state_ThermometerSet_behaviorThermometerSet_Init, state_ThermometerSet_behaviorThermometerSet_Idle) {
			@Override
		...
		transitions_ThermometerSet_behaviorThermometerSet.add(new Transition("815179920", timer_timeoutType, timer_port,
				state_ThermometerSet_behaviorThermometerSet_Idle, state_ThermometerSet_behaviorThermometerSet_Idle) {
			@Override
			public void doExecute(final Event e) {
				...
				while (getThermometerSet_i_var() < getThermometerSet_last_thermo_var()) {
					...
					ThermometerSet_temp_s_var = (float) (ThermometerSet_thermoval_var[getThermometerSet_i_var()]);
					if (getThermometerSet_temp_s_var() > -40 && getThermometerSet_temp_s_var() < 50) {
						sendTemperature_via_provide_val((short) (getThermometerSet_id_s_var()),
								(String) (ThermometerSet_thermotext_var[getThermometerSet_i_var()]),
								(float) (getThermometerSet_temp_s_var()));
						sendTemperature_via_show_values((short) (getThermometerSet_id_s_var()),
								(String) (ThermometerSet_thermotext_var[getThermometerSet_i_var()]),
								(float) (getThermometerSet_temp_s_var()));
		...
		transitions_ThermometerSet_behaviorThermometerSet.add(new Transition("927805736", add_thermometerType,
				require_val_port, state_ThermometerSet_behaviorThermometerSet_Idle,
				state_ThermometerSet_behaviorThermometerSet_Idle) {
			@Override
			public void doExecute(final Event e) {
		...
		transitions_ThermometerSet_behaviorThermometerSet.add(new Transition("726083556", temperatureType,
				get_values_port, state_ThermometerSet_behaviorThermometerSet_Idle,
				state_ThermometerSet_behaviorThermometerSet_Idle) {
			@Override
			public void doExecute(final Event e) {
		...
		final CompositeState state_ThermometerSet_behaviorThermometerSet = new CompositeState("behaviorThermometerSet",
				states_ThermometerSet_behaviorThermometerSet, state_ThermometerSet_behaviorThermometerSet_Init,
				transitions_ThermometerSet_behaviorThermometerSet, regions_ThermometerSet_behaviorThermometerSet,
				false);
