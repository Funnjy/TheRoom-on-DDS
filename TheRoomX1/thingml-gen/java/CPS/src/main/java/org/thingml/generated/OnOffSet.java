...
transitions_OnOffSet_behaviorOnOffSet.add(new Transition("1036277238",initializeType, initial_port, state_OnOffSet_behaviorOnOffSet_Init, state_OnOffSet_behaviorOnOffSet_Idle){
@Override
...
transitions_OnOffSet_behaviorOnOffSet.add(new Transition("1004780164",add_deviceType, require_val_port, state_OnOffSet_behaviorOnOffSet_Idle, state_OnOffSet_behaviorOnOffSet_Idle){
@Override
public void doExecute(final Event e) {
...
transitions_OnOffSet_behaviorOnOffSet.add(new Transition("1671391757",SwitchOnType, require_val_port, state_OnOffSet_behaviorOnOffSet_Idle, state_OnOffSet_behaviorOnOffSet_Idle){
@Override
public void doExecute(final Event e) {
...
transitions_OnOffSet_behaviorOnOffSet.add(new Transition("1115311464",SwitchOffType, require_val_port, state_OnOffSet_behaviorOnOffSet_Idle, state_OnOffSet_behaviorOnOffSet_Idle){
@Override
public void doExecute(final Event e) {
