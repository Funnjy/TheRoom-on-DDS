...
public class OnOffSet extends Component implements IOnOffSet_require_val, IOnOffSet_initial {
	...
	private Collection<IOnOffSet_show_valClient> show_val_clients = Collections
			.synchronizedCollection(new LinkedList<IOnOffSet_show_valClient>());
	...
	public OnOffSet(String name, final String OnOffSet_ts_var, final short[] OnOffSet_onoffswitches_var,
			final short OnOffSet_last_onoff_var, final boolean[] OnOffSet_poweron_var, final short OnOffSet_i_var,
			final short OnOffSet_did_var, final int OnOffSet_mth_var, final boolean OnOffSet_found_var,
			final int OnOffSet_status_var) {
		super(name);
	...
	private CompositeState buildOnOffSet_behaviorOnOffSet() {
		...
		transitions_OnOffSet_behaviorOnOffSet.add(new Transition("1036277238", initializeType, initial_port,
				state_OnOffSet_behaviorOnOffSet_Init, state_OnOffSet_behaviorOnOffSet_Idle) {
			@Override
		...
		transitions_OnOffSet_behaviorOnOffSet.add(new Transition("1004780164", add_deviceType, require_val_port,
				state_OnOffSet_behaviorOnOffSet_Idle, state_OnOffSet_behaviorOnOffSet_Idle) {
			@Override
			public void doExecute(final Event e) {
		...
		transitions_OnOffSet_behaviorOnOffSet.add(new Transition("1671391757", SwitchOnType, require_val_port,
				state_OnOffSet_behaviorOnOffSet_Idle, state_OnOffSet_behaviorOnOffSet_Idle) {
			@Override
			public void doExecute(final Event e) {
		...
		transitions_OnOffSet_behaviorOnOffSet.add(new Transition("1115311464", SwitchOffType, require_val_port,
				state_OnOffSet_behaviorOnOffSet_Idle, state_OnOffSet_behaviorOnOffSet_Idle) {
			@Override
			public void doExecute(final Event e) {
		...
		final CompositeState state_OnOffSet_behaviorOnOffSet = new CompositeState("behaviorOnOffSet",
				states_OnOffSet_behaviorOnOffSet, state_OnOffSet_behaviorOnOffSet_Init,
				transitions_OnOffSet_behaviorOnOffSet, regions_OnOffSet_behaviorOnOffSet, false);
