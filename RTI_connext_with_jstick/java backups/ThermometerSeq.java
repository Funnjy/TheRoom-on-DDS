...
/**
* A sequence of Thermometer instances.
*/
public final class ThermometerSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ThermometerSeq() {
        super(Thermometer.class);
    }

    public ThermometerSeq (int initialMaximum) {
        super(Thermometer.class, initialMaximum);
    }

    public ThermometerSeq (Collection elements) {
        super(Thermometer.class, elements);
    }

    public  Thermometer get(int index) { 
        return (Thermometer) super.get(index); 
    }
