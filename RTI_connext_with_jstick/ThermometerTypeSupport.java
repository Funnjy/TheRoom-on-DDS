...
public class ThermometerTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Thermometer";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ThermometerTypeSupport _singleton
    = new ThermometerTypeSupport();
    ...
    */
    public static ThermometerTypeSupport get_instance() {
        return _singleton;
    }

    public static ThermometerTypeSupport getInstance() {
        return get_instance();
    }
    ...
    * <code>this</code> is not a <code>Thermometer</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Thermometer typedDst = (Thermometer) destination;
        Thermometer typedSrc = (Thermometer) source;
        ...
        Object sample) 
    {
        ...
        Thermometer typedSrc = (Thermometer) sample;
    ...
    int mask) {
        return new ThermometerDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ThermometerDataReader(native_reader, listener, mask, this);   
    ...
    protected ThermometerTypeSupport() {
